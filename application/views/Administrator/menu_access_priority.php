...
<div id="userAccess">
    ...
    <div class="row" id="accessRow">
        <div class="col-md-3">
            ...
            <div class="group">
                <input type="checkbox" id="orders" class="group-head" @click="onClickGroupHeads"> <strong>Orders</strong>
                <ul ref="orders">
                    <li><input type="checkbox" class="access" value="order" v-model="access"> Order Entry</li>
