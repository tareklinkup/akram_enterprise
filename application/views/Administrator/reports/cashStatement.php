		...
		<div class="row" style="padding-top:10px;">
			<div class="col-md-6">
				...
				<table class="table table-bordered table-condensed">
					...
					<tbody style="display:none;" v-bind:style="{display: receivedFromCustomers.length > 0 ? '' : 'none'}">
						<tr v-for="payment in receivedFromCustomers">
							...
							<td style="text-align:right;">{{ payment.CPayment_discount_amount | decimal }}</td>
						</tr>
					</tbody>
					<tfoot>
						<tr style="font-weight:bold;">
							...
							<td style="text-align:right;">
								<span v-if="receivedFromCustomers.length == 0">0.00</span>
								<span style="display:none;" v-bind:style="{display: receivedFromCustomers.length > 0 ? '' : 'none'}">{{ totalReceivedDiscountFromCustomers | decimal }}</span>
							</td>
						</tr>
					</tfoot>
				</table>
				...
				<table class="table table-bordered table-condensed">
					<thead>
						<tr style="background: #dee4dc;">
							<th colspan="5">Received from Suppliers</th>
						</tr>
						<tr>
							<th>Invoice</th>
							<th>Date</th>
					...
					<tbody style="display:none;" v-bind:style="{display: receivedFromSuppliers.length > 0 ? '' : 'none'}">
						<tr v-for="payment in receivedFromSuppliers">
							...
							<td style="text-align:right;">{{ payment.SPayment_discount_amount | decimal }}</td>
						</tr>
					</tbody>
					<tfoot>
						<tr style="font-weight:bold;">
							...
							<td style="text-align:right;">
								<span v-if="receivedFromSuppliers.length == 0">0.00</span>
								<span style="display:none;" v-bind:style="{display: receivedFromSuppliers.length > 0 ? '' : 'none'}">{{ totalReceivedDiscountFromSuppliers | decimal }}</span>
							</td>
						</tr>
					</tfoot>
				</table>
				...
				<table class="table table-bordered table-condensed">
					...
					<tfoot>
						<tr style="font-weight:bold;">
							...
							<td style="text-align:right;">
								<span v-if="paidToSuppliers.length == 0">0.00</span>
								<span style="display:none;" v-bind:style="{display: paidToSuppliers.length > 0 ? '' : 'none'}">{{ totalPaidDiscountToSuppliers | decimal }}</span>
							</td>
						</tr>
					</tfoot>
				</table>
				...
				<table class="table table-bordered table-condensed">
					...
					<tfoot>
						<tr style="font-weight:bold;">
							...
							<td style="text-align:right;">
								<span v-if="paidToCustomers.length == 0">0.00</span>
								<span style="display:none;" v-bind:style="{display: paidToCustomers.length > 0 ? '' : 'none'}">{{ totalPaidDiscountToCustomers | decimal }}</span>
							</td>
						</tr>
					</tfoot>
				</table>
...
<script>
	new Vue({
		...
		computed: {
			...
			totalReceivedDiscountFromCustomers() {
				return this.receivedFromCustomers.reduce((prev, curr) => {
					return prev + parseFloat(curr.CPayment_discount_amount)
				}, 0).toFixed(2);
			},
			...
			totalReceivedDiscountFromSuppliers() {
				return this.receivedFromSuppliers.reduce((prev, curr) => {
					return prev + parseFloat(curr.SPayment_discount_amount)
				}, 0).toFixed(2);
			},
