...
<div id="stock">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<h6>Damage Serial Detail </h6>
			<table class="table" style="display: none;" :style="{display: serialReport.damageReport ? '' : 'none'}">

				<tr v-for="(serial, sl) in serialReport.damageReport">
					<td>Damage Code : </td>
					<td>{{ serial.invoiceNo }}</td>
				</tr>
				<tr v-for="(serial, sl) in serialReport.damageReport">
