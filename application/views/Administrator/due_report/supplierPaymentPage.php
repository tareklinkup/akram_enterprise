			...
			<form @submit.prevent="saveSupplierPayment">
				<div class="row">
					...
					<div class="col-md-5">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">Discount Amount</label>
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="number" step="any" class="form-control" v-model="payment.SPayment_discount_amount" required>
							</div>
						</div>
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="number" step="any" class="form-control" v-model="payment.SPayment_amount" required>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-5"></label>
							<label class="col-md-7">
								<input type="checkbox" v-model="payment.sendSMS" class="form-check-input" id="exampleCheck1">
				...
				<datatable :columns="columns" :data="payments" :filter-by="filter" style="margin-bottom: 5px;">
					<template scope="{ row }">
						<tr>
							...
							<td>{{ row.SPayment_discount_amount }}</td>
	...
	new Vue({
			...
			return {
				...
				columns: [{
					...
					},
					{
						...
						field: 'SPayment_discount_amount',
						align: 'center'
					},
					{
						label: 'Amount',
		...
		methods: {
			...
			resetForm() {
				...
				this.payment.SPayment_discount_amount = '';
				this.payment.SPayment_amount = '';
				this.payment.SPayment_notes = '';
				this.payment.sendSMS = false;
