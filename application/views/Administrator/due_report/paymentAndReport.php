...
$totalDue = $type == 'CR' ? $prevdueAmont - ($CPROW->CPayment_amount + $CPROW->CPayment_discount_amount) : $prevdueAmont + ($CPROW->CPayment_amount + $CPROW->CPayment_discount_amount);
...
<a href="<?php echo base_url();?>customerPaymentPage" title="" class="buttonAshiqe">Go Back</a>
    <div id="reportContent">
            ...
            <div class="col-xs-12">
                <table class="border" cellspacing="0" cellpadding="0" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <td style="text-align:right;"><?php if($CPROW->CPayment_discount_amount != ''): echo number_format($CPROW->CPayment_discount_amount, 2); else: echo '00.00'; endif; ?></td>
                        </tr>
                        <tr>
                            ...
                            <th style="font-size: 13px; font-weight: 700;text-align:right;"><?php if($CPROW->CPayment_discount_amount != ''): echo number_format($CPROW->CPayment_discount_amount, 2); else: echo '00.00'; endif; ?></th>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12">
                <h6 style=" font-size: 12px; font-weight: 600;">Paid (In Word): <?php echo convertNumberToWord($CPROW->CPayment_amount+$CPROW->CPayment_discount_amount);?></h6>
            </div>
        </div>
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12 text-left;">
                <table style="width: 25%;float:left;">
                    ...
                    <tr>
                        ...
                        <td  style="font-size: 13px; font-weight: 600; border-bottom: 2px solid #000; text-align: right; "><?php echo number_format($CPROW->CPayment_amount+$CPROW->CPayment_discount_amount, 2); ?></td>
                    </tr>
                    <tr>
