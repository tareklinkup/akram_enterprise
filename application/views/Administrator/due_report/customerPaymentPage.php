				...
				<div class="row">
					...
					<div class="col-md-5">
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="number" step="any" class="form-control" v-model="payment.CPayment_discount_amount" required>
							</div>
						</div>
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="number" step="any" class="form-control" v-model="payment.CPayment_amount" required>
							</div>
						</div>
						<div class="form-group">
				...
				<datatable :columns="columns" :data="payments" :filter-by="filter" style="margin-bottom: 5px;">
					<template scope="{ row }">
						<tr>
							...
							<td>{{ row.CPayment_discount_amount }}</td>
	...
	new Vue({
			...
			return {
				...
				columns: [{
					...
					},
					{
						...
						field: 'CPayment_discount_amount',
						align: 'center'
					},
					{
						label: 'Amount',
		...
		methods: {
			...
			resetForm() {
				...
				this.payment.CPayment_discount_amount = '';
