...
<?php } elseif ($module == 'OrderModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("order", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
		...
		<?php endif; ?>
		<?php if (array_search("order_record", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
