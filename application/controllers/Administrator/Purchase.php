...
class Purchase extends CI_Controller
{
        ...
        try {
            ...
            if(!empty($data->ps_id)){
                $serial = array( 
                    'ps_d_status'=> 'yes',
                    'ps_damage_date'=> date('Y-m-d'),
                    'damage_details_id'=> $oldProduct->ps_id
                );
                $this->db->where('ps_id', $data->ps_id)->update('tbl_product_serial_numbers', $serial);
            }            
    ...
    public function deleteDamage(){
        ...
        try {
            ...
            $this->db->where('damage_details_id', $oldProduct->DamageDetails_SlNo)->where('ps_prod_id', $oldProduct->Product_SlNo)->update('tbl_product_serial_numbers', $serial);
